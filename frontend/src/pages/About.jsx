...
function About() {
  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <br />
      <span>
        Kumar  is dedicated to leveraging his expertise to contribute to
      ...
      <p>
        Beyond his professional achievements, Kumar is a big fan of cricket and
        holds immense admiration for <strong> King Kohli.</strong> His favorite
        person and biggest inspiration is his twin brother,{" "}
        <strong>Om.</strong> Their friendly rivalry and deep bond have
        significantly shaped Kumar journey. Om is not only a great
        competitor but also a steadfast friend, constantly motivating Kumar to
