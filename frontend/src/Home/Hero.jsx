...
function Hero() {
  const { blogs } = useAuth();
  console.log("heroBlogs", blogs);

  return (
    <div className="container mx-auto my-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 p-6">
          ...
          return (
            ...
            >
              <div className="group relative">
                ...
                <h1 className=" absolute bottom-4 left-4 text-white text-xl font-bold group-hover:text-green-500 transition-colors duration-300">
                  {element.title}
                </h1>
              </div>
